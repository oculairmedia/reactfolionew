...
export const Links: React.FC = () => {
  return (
    <HelmetProvider>
      ...
      <div className="links-container bg-base-100 text-base-content">
        <div className="bento-grid animate-fade-in-up">
          <div className="bento-card col-span-1 md:col-span-2 row-span-2 bg-base-100 flex flex-col items-center justify-center p-8 text-center gap-4">
            <div className="avatar">
              <div className="w-32 rounded-full ring ring-base-content ring-offset-base-100 ring-offset-2">
                <img
