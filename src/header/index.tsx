      ...
      <header className="fixed-top site__header">
        <div className="d-flex align-items-center justify-content-between">
          ...
          <nav className="desktop-nav">
            ...
            <a href="#contact-footer" onClick={(e: React.MouseEvent<HTMLAnchorElement>) => { e.preventDefault(); document.getElementById('contact-footer')?.scrollIntoView({ behavior: 'smooth' }); }}>Contact</a>
          ...
          <div className="menu__wrapper">
            <div className="menu__container p-3">
              <ul className="the_menu">
                ...
                <li className="menu_item">
                  <a onClick={(e: React.MouseEvent<HTMLAnchorElement>) => { e.preventDefault(); handleToggle(); setTimeout(() => document.getElementById('contact-footer')?.scrollIntoView({ behavior: 'smooth' }), 300); }} href="#contact-footer" className="my-3"> Contact</a>
                </li>
                <li className="menu_item">
