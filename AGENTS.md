...
- **Letta Agent ID**: `agent-7659b796-4723-4d61-98b5-737f874ee652`

## Workflow Instructions

1. **Before starting work**: Search Huly for related issues using `huly-mcp` with project code `PSITE`
2. **Issue references**: All issues for this project use the format `PSITE-XXX` (e.g., `PSITE-123`)
...
**Project PM Agent:** `Huly - Personal Site` (agent-7659b796-4723-4d61-98b5-737f874ee652)
...
```json
{
  ...
  "agent": "Huly - Personal Site",
  "message": "<your report>",
  "caller_directory": "/opt/stacks/personal-site"
}
```
...
**Project**: Personal Site (`PSITE`)
**Path**: `/opt/stacks/personal-site`
